...
export const when = function () {
    return [{
        "User change status of issue $issueId to $status": (assert, ctx) => async function (issueId, status) {
            ...
            let parentEl = item.closest('div.milestone.box-body');
            let target = parentEl.querySelector(`div.lane.box-body[data-field-status="${status}"]`);
