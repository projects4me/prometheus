...
export default DS.JSONAPIAdapter.extend(DataAdapterMixin,{
  ...
  */
  ...
  /**
    ...
    @method pathForType
    @param modelName String The model name that is being fetched
    @return modelName String The singularized modelName
    @for ApplicationAdapter
    @private
  */
  ...
  /**
    ...
    @param status String The status code returned by the API
    @for ApplicationAdapter
    @private
