...
import WikiCreateController from "prometheus/controllers/app/project/wiki/create";
 ...
 * @extends Prometheus
 */
export default class WikiEditController extends WikiCreateController.extend(ProjectRelated) {
